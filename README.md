...
```sh
curl -fsSLO https://github.com/anwen-labs/sentinel/releases/download/v0.1.4/sentinel-v0.1.4-x86_64-unknown-linux-gnu.tar.gz
curl -fsSLO https://github.com/anwen-labs/sentinel/releases/download/v0.1.4/sentinel-v0.1.4-x86_64-unknown-linux-gnu.sha256
sha256sum -c <(awk '{print $1"  sentinel-v0.1.4-x86_64-unknown-linux-gnu.tar.gz"}' sentinel-v0.1.4-x86_64-unknown-linux-gnu.sha256)
tar xzf sentinel-v0.1.4-x86_64-unknown-linux-gnu.tar.gz && sudo mv sentinel /usr/local/bin/
```
...
```yaml
- uses: anwen-labs/sentinel@v0.1.4
  with:
